...
def train_one_epoch(sess, ops, train_writer):
    ...
    while fn < len(TRAIN_FILES) - 1:
        ...
        total_current = [];
        a1, a2, a3, a4, _ = provider.loadDataFile_cut_4(TRAIN_FILES[train_file_idxs[fn]], False)
        ...
        b1, b2, b3, b4, _ = provider.loadDataFile_cut_4(TRAIN_FILES[train_file_idxs[fn]], False)
