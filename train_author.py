...
def train_one_epoch(sess, ops, train_writer):
    ...
    current_data_1 = np.empty([28*len(TRAIN_FILES), NUM_POINT, 3], dtype=float)
    current_data_2 = np.empty([28*len(TRAIN_FILES), NUM_POINT, 3], dtype=float)
    current_label = np.empty([28*len(TRAIN_FILES),1], dtype=int)
